...
This repository includes the code for the backend API Server used to develop and interact with the front-end portion of the project.
...
* Start the API server
    ...
    - `npm install`
    - `node server`
* In another terminal window, start the front-end dev server
    - `cd frontend`
    - `npm start`
